...
if old not in t:
    raise SystemExit('current year function not found')
t=t.replace(old,helper,1)
oldopt='                                        <option value="2026-2027">2026-2027</option>\n                                    </select>'
newopt='                                        <option value="2026-2027">2026-2027</option>\n                                        <option value="2027-2028">2027-2028</option>\n                                    </select>'
if t.count(oldopt)<1: raise SystemExit('term year option not found')
t=t.replace(oldopt,newopt,1)
oldconfirm='                const academicYear = document.getElementById(\'confirmAcademicYear\').value;'
newconfirm="""                const academicYear = getAcademicYearForEnrollmentDate(insc.dateInscription || insc.timestamp || new Date());
...
if oldconfirm not in t: raise SystemExit('confirm year line not found')
t=t.replace(oldconfirm,newconfirm,1)
# Add 2027-2028 to the confirmation modal specifically.
needle='                                        <option value="2026-2027">2026-2027</option>\n                                    </select>\n                                </div>\n                                <div class="col-md-6">\n                                    <label class="form-label">Classe affect'
repl='                                        <option value="2026-2027">2026-2027</option>\n                                        <option value="2027-2028">2027-2028</option>\n                                    </select>\n                                </div>\n                                <div class="col-md-6">\n                                    <label class="form-label">Classe affect'
if needle not in t: raise SystemExit('confirm modal option not found')
